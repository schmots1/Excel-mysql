...
echo "<tr bgcolor=grey><td>Filer</td><td>Volume</td><td>Block Type</td><td>Used Space</td><td>File Count</td><td>Aggregate</td><td>Security Style</td><td>Number of Qtrees</td><td>Number of Luns</td><td>Number of Snapmirrors</td><td>Number of Snapvaults</td><td>State</td><td>Language</td><td>Vfiler</td>";
if (!empty($_GET['block'])) {
...
echo "<tr style=\"background:$alt\"><td>"  . $row['storage_controller'] . "</td><td>" . $row['name'] . "</td><td>" . $row['block_type'] . "</td><td>" . $row['total_used_size_GB'] . "</td><td>" . $row['files_used'] . "</td><td>" . $row['aggregate_name'] . "</td><td>" . $row['security_style'] . "</td><td>" . $row['total_qtrees'] . "</td><td>" . $row['total_luns'] . "</td><td>" . $row['total_snapmirrors'] . "</td><td>" . $row['total_snapvaults'] . "</td><td>" . $row['state'] . "</td><td>" . $row['language'] . "</td><td>" . $row['vfiler_name'];
}
echo "</td></tr>";
//echo "$result</td>";
}
