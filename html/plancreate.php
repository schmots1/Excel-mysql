...
$sql = "create table `Migration_Plan` (`id` INT(6) auto_increment primary key, `source_filer` varchar(100), `source_volume` varchar(100), `destination_cluster` varchar(100), `destination_svm` varchar(100), `destination_node` varchar(100), `destination_aggr` varchar(100), `classification` varchar(100), `application` varchar(100), `app_owner` varchar(100), `owner_email` varchar(100), `move_group` varchar(100), `group_email` varchar(100), `orginization` varchar(100), `service_level` varchar(100), `imt_ready` varchar(25), `comments` varchar(256), `migration_method` varchar(50), `stage` varchar(50))";
